...
# แปลงข้อมูลให้เป็นค่าบวกทั้งหมด (MultinomialNB ไม่รองรับค่าลบ)
X = X - X.min().min()

# แบ่งข้อมูลเป็น Train และ Test
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=0)

# สร้างและเทรนโมเดล Multinomial Naive Bayes
model = MultinomialNB()
...
model_file_path = "models/pkl/multinomial_nb_model.pkl"
